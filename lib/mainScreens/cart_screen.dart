...
import 'package:superfood_users_app/mainScreens/address_screen.dart';
import 'package:superfood_users_app/models/items.dart';
import 'package:superfood_users_app/splashScreen/splash_screen.dart';
import 'package:superfood_users_app/widgets/cart_item_design.dart';
import 'package:superfood_users_app/widgets/progress_bar.dart';
import 'package:superfood_users_app/widgets/text_widget_header.dart';
      ...
      appBar: AppBar(
        ...
        actions: [
          Stack(
            children: [
              IconButton(
                icon: const Icon(Icons.shopping_cart, color: Colors.deepPurpleAccent,),
                onPressed: ()
                {
                  print("clicked");
                },
